...
class SpraycanAtlasSprite extends FlxSpriteGroup
{
	...
	public function new(x:Float = 0, y:Float = 0)
	{
		...
		// FlxAnim does not have finishCallback. To run code when an animation finishes, poll in update():
		// Example: if (canAtlas.anim.curAnim != null && canAtlas.anim.curAnim.finished) finishCanAnimation();
